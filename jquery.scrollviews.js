...
(function (global, factory) {
	...
	var WRAPPER = 'scrollviews-wrapper';
	var WRAPPER_SEL = '.' + WRAPPER;

	// slimscroll
	var SCROLLABLE = 'svs-scrollable';
	var SCROLLABLE_SEL = '.' + SCROLLABLE;

	// util
	var RESPONSIVE = 'svs-responsive';
	...
	var COMPLETELY = 'svs-completely';
	var COMPLETELY_SEL = '.' + COMPLETELY;

	// section
	var SECTION_DEFAULT_SEL = '.section';
	var SECTION = 'svs-section';
	var SECTION_SEL = '.' + SECTION;
	var SECTION_ACTIVE_SEL = SECTION_SEL + ACTIVE_SEL;
	var SECTION_FIRST_SEL = SECTION_SEL + ':first';
	var SECTION_LAST_SEL = SECTION_SEL + ':last';
	var TABLE_CELL = 'svs-tableCell';
	var TABLE_CELL_SEL = '.' + TABLE_CELL;
	var AUTO_HEIGHT = 'svs-auto-height';
	var AUTO_HEIGHT_SEL = '.svs-auto-height';
	var NORMAL_SCROLL = 'svs-normal-scroll';
	var NORMAL_SCROLL_SEL = '.svs-normal-scroll';

	// sub-view
	var SUBVIEW_DEFAULT_SEL = '.subview';
	var SUBVIEW = 'svs-subview';
	var SUBVIEW_SEL = '.' + SUBVIEW;
	var SUBVIEW_ACTIVE_SEL = SUBVIEW_SEL + ACTIVE_SEL;
	var SUBVIEW_FIRST_SEL = SUBVIEW_SEL + ':first';
	var SUBVIEW_LAST_SEL = SUBVIEW_SEL + ':last';

	// section nav
	var SECTION_NAV = 'svs-nav';
	var SECTION_NAV_SEL = '#' + SECTION_NAV;
	var SECTION_NAV_TOOLTIP = 'svs-tooltip';
	var SECTION_NAV_TOOLTIP_SEL = '.' + SECTION_NAV_TOOLTIP;
	var SHOW_ACTIVE_TOOLTIP = 'svs-show-active';
	...
	var SLIDES_WRAPPER = 'svs-slides';
	var SLIDES_WRAPPER_SEL = '.' + SLIDES_WRAPPER;
	var SLIDES_CONTAINER = 'svs-slidesContainer';
	var SLIDES_CONTAINER_SEL = '.' + SLIDES_CONTAINER;
	var TABLE = 'svs-table';

	// slide nav
	var SLIDES_NAV = 'svs-slidesNav';
	var SLIDES_NAV_SEL = '.' + SLIDES_NAV;
	var SLIDES_NAV_LINK_SEL = SLIDES_NAV_SEL + ' a';
	var SLIDES_ARROW = 'svs-controlArrow';
	var SLIDES_ARROW_SEL = '.' + SLIDES_ARROW;
	var SLIDES_PREV = 'svs-prev';
	var SLIDES_PREV_SEL = '.' + SLIDES_PREV;
	var SLIDES_ARROW_PREV = SLIDES_ARROW + ' ' + SLIDES_PREV;
	var SLIDES_ARROW_PREV_SEL = SLIDES_ARROW_SEL + SLIDES_PREV_SEL;
	var SLIDES_NEXT = 'svs-next';
	...
	$.fn.scrollviews = function (options) {
		//only once my friend!
		...
		options = $.extend({
			...
			scrollOverflowHandler: $.fn.svs_scrolloverflow ? $.fn.svs_scrolloverflow.iscrollHandler : null,
			...
			subviewSelector: SUBVIEW_DEFAULT_SEL,
		...
		function moveSectionUp() {
			...
			if (subViews.length > 0) {
				...
				if (prevSubView.length === 1) {
					...
					activeSubView.removeClass(ACTIVE);
					prevSubView.addClass(ACTIVE);
					return;
				}
			}
        ...
        */
        ...
        /**
        * Turns scrollviews to normal scrolling mode when the viewport `width` or `height`
        ...
        */
        ...
        /**
        * Works over the DOM structure to set it up for the current ScrollViewsJS options.
        */
		function prepareDom() {
			container.css({
				'height': '100%',
        ...
        */
		function addInternalSelectors() {
			...
			container.find(options.subviewSelector).addClass(SUBVIEW);
        ...
        * A class `svs-responsive` is added to the plugin's container in case the user wants to use it for his own responsive CSS.
        */
		function responsive() {
        ...
        */
        ...
        /*
        * Destroys ScrollViewsJS.js plugin events and optinally its html markup and styles
        */
        ...
        /*
        * Removes inline styles added by ScrollViewsJS
        */
		function destroyStructure() {
			...
			//removing the applied transition from the ScrollViewsJS wrapper
			container.css({
        ...
        */
		function displayWarnings() {
			...
			if ($('html').hasClass(ENABLED)) {
				showError('error', 'ScrollViewsJS can only be initialized once and you are doing it multiple times!');
				return;
			}
			...
			if (options.scrollOverflow && !options.scrollOverflowHandler) {
				...
				showError('error', 'The option `scrollOverflow:true` requires the file `scrolloverflow.min.js`. Please include it before jquery.scrollviews.js.');
			}
        ...
        */
		function showError(type, text) {
			console && console[type] && console[type]('jQuery ScrollViewsJS: ' + text);
		}

	}; //end of $.fn.scrollviews
});
