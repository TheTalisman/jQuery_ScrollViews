 ...
 */
function(t,i){"undefined"!=typeof IScroll&&(IScroll.prototype.wheelOn=function(){this.wrapper.addEventListener("wheel",this),this.wrapper.addEventListener("mousewheel",this),this.wrapper.addEventListener("DOMMouseScroll",this)},IScroll.prototype.wheelOff=function(){this.wrapper.removeEventListener("wheel",this),this.wrapper.removeEventListener("mousewheel",this),this.wrapper.removeEventListener("DOMMouseScroll",this)}),t.iscrollHandler={refreshId:null,iScrollInstances:[],toggleWheel:function(t){i(".fp-section.active").find(".fp-scrollable").each(function(){var e=i(this).data("iscrollInstance");void 0!==e&&e&&(t?e.wheelOn():e.wheelOff())})},onLeave:function(){iscrollHandler.toggleWheel(!1)},beforeLeave:function(){iscrollHandler.onLeave()},afterLoad:function(){iscrollHandler.toggleWheel(!0)},create:function(t,e,s){var o=t.find(".fp-scrollable");o.height(e),o.each(function(){var t=i(this),e=t.data("iscrollInstance");e&&i.each(iscrollHandler.iScrollInstances,function(){i(this).destroy()}),e=new IScroll(t.get(0),s),e.on("scrollEnd",function(){this.fp_isAtTop=this.y>-30,this.fp_isAtEnd=this.y-this.maxScrollY<30}),iscrollHandler.iScrollInstances.push(e),e.wheelOff(),t.data("iscrollInstance",e)})},isScrolled:function(t,i){var e=i.data("iscrollInstance");return!e||("top"===t?e.y>=0&&!i.scrollTop():"bottom"===t?0-e.y+i.scrollTop()+1+i.innerHeight()>=i[0].scrollHeight:void 0)},scrollable:function(t){return t.find(".fp-slides").length?t.find(".fp-slide.active").find(".fp-scrollable"):t.find(".fp-scrollable")},scrollHeight:function(t){return t.find(".fp-scrollable").children().first().get(0).scrollHeight},remove:function(t){var i=t.find(".fp-scrollable");if(i.length){var e=i.data("iscrollInstance");e&&e.destroy(),i.data("iscrollInstance",null)}t.find(".fp-scrollable").children().first().children().first().unwrap().unwrap()},update:function(t,e){clearTimeout(iscrollHandler.refreshId),iscrollHandler.refreshId=setTimeout(function(){i.each(iscrollHandler.iScrollInstances,function(){i(this).get(0).refresh()})},150),t.find(".fp-scrollable").css("height",e+"px").parent().css("height",e+"px")},wrapContent:function(){return'<div class="fp-scrollable"><div class="fp-scroller"></div></div>'}}}(window,jQuery),function(t,i,e){$.fn.fp_scrolloverflow=function(){function e(){function e(){$("body").hasClass(a)?c():r(o),$.fn.fullpage.shared.afterRenderActions()}function o(i){if(!i.hasClass("fp-noscroll")){i.css("overflow","hidden");var e,o=p.options.scrollOverflowHandler,n=o.wrapContent(),r=i.closest(s),a=o.scrollable(i);a.length?e=o.scrollHeight(i):(e=i.get(0).scrollHeight,p.options.verticalCentered&&(e=i.find(h).get(0).scrollHeight));var l=$(t).height()-parseInt(r.css("padding-bottom"))-parseInt(r.css("padding-top"));e>l?a.length?o.update(i,l):(p.options.verticalCentered?i.find(h).wrapInner(n):i.wrapInner(n),o.create(i,l,p.iscrollOptions)):o.remove(i),i.css("overflow","")}}function r(t){$(s).each(function(){var i=$(this).find(n);i.length?i.each(function(){t($(this))}):t($(this))})}function c(){var t=p.options.scrollOverflowHandler;r(function(i){i.closest(s).hasClass(l)&&t.remove(i)})}var p=this;p.options=null,p.init=function(s,o){return p.options=s,p.iscrollOptions=o,"complete"===i.readyState&&e(),$(t).on("load",e),p},p.createScrollBarForAll=e}var s=".fp-section",o=s+".active",n=".fp-slide",r=n+".active",h=".fp-tableCell",a="fp-responsive",l="fp-auto-height-responsive";IScroll.prototype.wheelOn=function(){this.wrapper.addEventListener("wheel",this),this.wrapper.addEventListener("mousewheel",this),this.wrapper.addEventListener("DOMMouseScroll",this)},IScroll.prototype.wheelOff=function(){this.wrapper.removeEventListener("wheel",this),this.wrapper.removeEventListener("mousewheel",this),this.wrapper.removeEventListener("DOMMouseScroll",this)};var c={refreshId:null,iScrollInstances:[],iscrollOptions:{scrollbars:!0,mouseWheel:!0,hideScrollbars:!1,fadeScrollbars:!1,disableMouse:!0,interactiveScrollbars:!0},init:function(i){var s="ontouchstart"in t||navigator.msMaxTouchPoints>0||navigator.maxTouchPoints;return c.iscrollOptions.click=s,c.iscrollOptions=$.extend(c.iscrollOptions,i.scrollOverflowOptions),(new e).init(i,c.iscrollOptions)},toggleWheel:function(t){$(o).find(".fp-scrollable").each(function(){var i=$(this).data("iscrollInstance");void 0!==i&&i&&(t?i.wheelOn():i.wheelOff())})},onLeave:function(){c.toggleWheel(!1)},beforeLeave:function(){c.onLeave()},afterLoad:function(){c.toggleWheel(!0)},create:function(t,i,e){var s=t.find(".fp-scrollable");s.height(i),s.each(function(){var t=$(this),i=t.data("iscrollInstance");i&&$.each(c.iScrollInstances,function(){$(this).destroy()}),i=new IScroll(t.get(0),e),c.iScrollInstances.push(i),i.wheelOff(),t.data("iscrollInstance",i)})},isScrolled:function(t,i){var e=i.data("iscrollInstance");return!e||("top"===t?e.y>=0&&!i.scrollTop():"bottom"===t?0-e.y+i.scrollTop()+1+i.innerHeight()>=i[0].scrollHeight:void 0)},scrollable:function(t){return t.find(".fp-slides").length?t.find(r).find(".fp-scrollable"):t.find(".fp-scrollable")},scrollHeight:function(t){return t.find(".fp-scrollable").children().first().get(0).scrollHeight},remove:function(t){var i=t.find(".fp-scrollable");if(i.length){i.data("iscrollInstance").destroy(),i.data("iscrollInstance",null)}t.find(".fp-scrollable").children().first().children().first().unwrap().unwrap()},update:function(t,i){clearTimeout(c.refreshId),c.refreshId=setTimeout(function(){$.each(c.iScrollInstances,function(){$(this).get(0).refresh()})},150),t.find(".fp-scrollable").css("height",i+"px").parent().css("height",i+"px")},wrapContent:function(){return'<div class="fp-scrollable"><div class="fp-scroller"></div></div>'}};return{iscrollHandler:c}}()}(window,jQuery);
